...
| `TestOnPluskalDataset.ipynb` | External validation using the MARTS-DB dataset reported by **Engst *et al.* (2026)** in [*BMC Bioinformatics*](https://doi.org/10.1186/s12859-025-06341-8). | Evaluation against an independent Pluskal Lab dataset. |
